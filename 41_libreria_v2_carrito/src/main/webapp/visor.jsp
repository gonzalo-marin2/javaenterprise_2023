...
<body>
	...
	function gestionarPeticion(url,params){
		$.get(url,params,function(data){
			var tabla="<table border='1'><tr><th>Título</th><th>ISBN</th><th>Precio</th><th>Páginas</th></tr>";
			$.each(data, function(i,l){
				tabla+="<tr><td>"+l.titulo+"</td><td>"+l.isbn+"</td><td>"+l.precio+"</td><td>"
				+l.paginas+"</td><td><a href='#' onclick='agregarCarrito("+l.isbn+")'>Agregar</a></td></tr>";
			});
			tabla+="</table>";
			$("#tbLibros").html(tabla);
		});
	...
	function pintarCarrito(params){
		...
		$.get(url,params,function(data){
			...
			$.each(data, function(i,l){
				tabla+="<tr><td>"+l.titulo+"</td><td>"+l.isbn+"</td><td>"+l.precio+"</td><td>"
				+l.paginas+"</td><td><a href='#' onclick='EliminarCarrito("+i+")'>Eliminar</a></td></tr>";
			});
			tabla+="</table>";
